    ...
    images={[
        {
            src: 'use_case__01_01',
            description:
                'The main timeline introduces the archive to the scholar. The search bar is visible in a prominent location.',
        },
        {
            src: 'use_case__01_02',
            description:
                'Searching lazy loads possible results. Common results are preloaded to give the best user experience.',
        },
        {
            src: 'use_case__01_03',
            description:
                'The detail view shows documents and events the participant is mentioned in. Color coded periods indicate job positions.',
        },
    ]}
/>
...
Iranian Scholar wants to know what the US involvement was in supplying chemical weapons to Iraq and to what extend that was know by the Iranian side.
    ...
    images={[
        {
            src: 'use_case__02_01',
            description:
                'The detail view of the Iran tag shows participants, events and documents in which Iran played a role. Activating the tag focuses on documents that involve "chemical weapons". ',
        },
        {
            src: 'use_case__02_02',
            description:
                'Clicking on a document shows the detail view, transscript and meta information about it.',
        },
    ]}
/>
