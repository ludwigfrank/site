...
<Carousel wrapper>
    <CustomImage imgSrc="attendants" />
    <CustomImage imgSrc="attendants2" />
    <CustomImage imgSrc="attendants3" />
    <CustomImage imgSrc="money" />
    <CustomImage imgSrc="route" />
    <CustomImage imgSrc="route2" />
    <CustomImage imgSrc="route3" />
    <CustomImage imgSrc="route4" />
    <CustomImage imgSrc="route5" />
</Carousel>
