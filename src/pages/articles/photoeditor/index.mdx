...
description: 'Redesign a photo editor for more than 10 million users and 200 companies. An editor that works in every context, from Amazon Aws to HP Sprocket.'
...
In 2016 I joined PhotoEditorSDK (9elements, img.ly) to prepare the a concept for the challenges ahead.
