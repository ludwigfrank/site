...
export const meta = {
    ...
    description: 'This is the mood app description',
    categories: ['university', 'app'],
    keywords: ['design', 'app', 'depression'],
    banner: 'images/banner.jpg',
    team: [
        {
            name: 'Theodor Hillman',
...
export const pageQuery = graphql`
    query BasicWithQuery {
        beach: file(relativePath: { eq: "articles/mood/images/beach.jpg" }) {
            childImageSharp {
